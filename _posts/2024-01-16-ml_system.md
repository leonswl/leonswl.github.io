...
![Overall Architecture Diagram](/assets/images/ml-system/ml_architecture_drawio.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![Hopswork Feature Store](/assets/images/ml-system/hopswork_feature_store.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![Forecast](/assets/images/ml-system/wandb_image_forecast.png){:style="display:block; margin-left:auto; margin-right:auto"}
![Test](/assets/images/ml-system/wandb_image_test.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![Airflow ML system DAGs](/assets/images/ml-system/ml_pipeline_dags.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![FastAPI docs](/assets/images/ml-system/fastapi.png)

### 6.2. Streamlit
Streamlit will be the frontend application that renders the data to visualise 2 dashboards:
1. predictions  
![Prediction Web App](/assets/images/ml-system/app-predictions.png){:style="display:block; margin-left:auto; margin-right:auto"}
2. monitoring metrics  
![Monitoring Web App](/assets/images/ml-system/app-monitoring.png){:style="display:block; margin-left:auto; margin-right:auto"}
