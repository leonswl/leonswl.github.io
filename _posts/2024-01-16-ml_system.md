...
![Overall Architecture Diagram](/assets/img/ml_system/ml_architecture_drawio.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![FastAPI docs](/assets/img/ml_system/fastapi.png)

### 6.2. Streamlit
Streamlit will be the frontend application that renders the data to visualise 2 dashboards:
1. predictions  
![Prediction Web App](/assets/img/ml_system/app-predictions.png){:style="display:block; margin-left:auto; margin-right:auto"}
2. monitoring metrics  
![Monitoring Web App](/assets/img/ml_system/app-monitoring.png){:style="display:block; margin-left:auto; margin-right:auto"}

## 7. System Deployment using GCP

The final step towards achieving a ML system running in production is deploying the entire architecture, artifacts and pipelines on a cloud provider (E.g. AWS, Azure or GCP) with CI/CD pipelines. 

This step has been omitted in this post to avoid cloud cost