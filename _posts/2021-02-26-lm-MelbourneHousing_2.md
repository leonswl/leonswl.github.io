---
layout: post
title: Predicting Melbourne Housing Prices Part 2
description: Using linear regression to predict housing prices in Melbourne. # Add post description (optional)
img: '/01_LE_MelbourneHousing_2_files/predictinghousingprices2.jpeg' # Add image post (optional)
...
```  
![eda_plot](/assets/img/01_LE_MelbourneHousing_2_files/01_LE_MelbourneHousing_2_7_1.png)
...
![Observed vs Predicted](/assets/img/01_LE_MelbourneHousing_2_files/01_LE_MelbourneHousing_2_12_1.png)
...
![Comparing Observed vs Predicted](/assets/img/01_LE_MelbourneHousing_2_files/01_LE_MelbourneHousing_2_23_1.png)
