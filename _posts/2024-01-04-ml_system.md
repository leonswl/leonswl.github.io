...
### 6.1. FastAPI    
FastAPI backend will consume the predicions and monitoring metrics from GCS and expose them through a RESTful API. 

### 6.2. Streamlit
Streamlit will be the frontend application that renders the data to show 2 dashboards:
1. forecast
