  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/leon.png" alt="Leon" className="mb-4" />

          <h1 className="mb-2 mt-0">Leon Sun</h1>
          <p>
            Curious Learner. Tech Enthusiast. Nerd.  {" "}
            {/* <Typed
              strings={[
                "Data Analytics",
                "Modelling",
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            ...
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/leonsunwailoong/">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="mailto:leonsunwailoong@gmail.com">
